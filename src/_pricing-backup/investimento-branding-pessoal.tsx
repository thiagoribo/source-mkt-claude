// BACKUP — Seção de Investimento: Branding Pessoal
// Preço: R$18.000 | Duração: 5–7 semanas
//
// Para restaurar: descomente {/* <InvestimentoPessoal /> */} em BrandingPessoal.tsx
...
export default InvestimentoPessoal;
